...
T1.Position = UDim2.new(0.499776021, 0, 0.407925308, 0)
T1.Size = UDim2.new(0, 144, 0, 13)
T1.Font = Enum.Font.Gotham
T1.Text = "Welcome to the Exploit"
...
T2.Position = UDim2.new(0.600776021, 0, 0.538823366, 0)
...
local function MNQEF_fake_script()
    ...
    script.Parent.T3.Text = "Thank you for using"
    wait(1)
    script.Parent.LoadBar:TweenSize(UDim2.new(0.50,0,0,7), "Out", "Quad", 0.5, true)
    script.Parent.T3.Text = "Thank you for using the Robloxian Roblox exploit"
    wait(1)
    script.Parent.LoadBar:TweenSize(UDim2.new(1,0,0,7), "Out", "Quad", 0.5, true)
    script.Parent.T3.Text = "Welcome and good luck not getting banned (^_^)"
    wait(1.5)
